...
def plot_hull_triang(coords, hull=None, triang=None):
    ...
    plt.xlabel('X')
    plt.ylabel('Y')
    plt.savefig('/root/Desktop/host/HW2/P3_plots/P3_A_plot_hull_triangulation.png', bbox_inches='tight', format='png') 
    plt.show()
...
plt.ylabel('y')
plt.show()
plt.savefig('/root/Desktop/host/HW2/P3_plots/P3_B_area_change', bbox_inches='tight')

#
#
#
# Part c
# surface is embedded in 3d space as [x, y, (x**2+y**2)]
# tangent vectors are o_x = do_dx = [1, 0, 2x], o_y = do_dy = [0, 1, 2x]
# induced metric is [E F , F G]
...
plt.xlabel('X')
plt.ylabel('Y')
plt.savefig('/root/Desktop/host/HW2/P3_plots/P3_C_metric_det', bbox_inches='tight')
plt.show()
...
plt.savefig('/root/Desktop/host/HW2/P3_plots/P3_D_surface_normals.png', bbox_inches='tight')
plt.show()
...
plt.savefig('/root/Desktop/host/HW2/P3_plots/P3_E_vertex_normals.png', bbox_inches='tight')
plt.show()
...
plt.grid(True)
plt.show()
plt.savefig('/root/Desktop/host/HW2/P3_plots/P3_F_second_fundamental_form.png', bbox_inches='tight')
...
plt.ylabel('y')
plt.grid(True)
plt.savefig('/root/Desktop/host/HW2/P3_plots/P3_G_Principal_Curvature_K1.png', bbox_inches='tight')
plt.show()
...
plt.ylabel('y')
plt.grid(True)
plt.savefig('/root/Desktop/host/HW2/P3_plots/P3_G_Principal_Curvature_K2.png', bbox_inches='tight')
plt.show()
...
plt.ylabel('y')
plt.grid(True)
plt.savefig('/root/Desktop/host/HW2/P3_plots/P3_G_Gaussian_Curvature.png', bbox_inches='tight')
plt.show()
...
plt.ylabel('y')
plt.grid(True)
plt.savefig('/root/Desktop/host/HW2/P3_plots/P3_G_Mean_Curvature.png', bbox_inches='tight')
plt.show()
